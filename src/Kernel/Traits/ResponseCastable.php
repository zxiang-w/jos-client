...
use JosClient\Kernel\Contracts\Arrayable;
use JosClient\Kernel\Exceptions\InvalidArgumentException;
use JosClient\Kernel\Exceptions\InvalidConfigException;
use JosClient\Kernel\Http\Response;
...
trait ResponseCastable
{
     ...
     * @return array|\JosClient\Kernel\Support\Collection|object|\Psr\Http\Message\ResponseInterface|string
     *
     * @throws \JosClient\Kernel\Exceptions\InvalidArgumentException
     * @throws \JosClient\Kernel\Exceptions\InvalidConfigException
     */
