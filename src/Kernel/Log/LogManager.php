...
namespace JosClient\Kernel\Log;

use JosClient\Application;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('JosClient', $this->prepareHandlers([new StreamHandler(
            \sys_get_temp_dir().'/jos_client/jos_client.log', $this->level(['level' => 'debug'])
        )]));
    }
    ...
    protected function createSyslogDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SyslogHandler(
                    'JosClient', $config['facility'] ?? LOG_USER, $this->level($config))
            ),
        ]);
    }
